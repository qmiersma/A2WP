class A2WP {
    ...
    // bodyData = {"title": title, "status": status}
    ...
    async call() {
        ...
        const bodyData = results.bodyData; 
        const imgUrl = results.imgUrl; 

        // Post with resulting data 
        this.postData({urlBuilder, bodyData, imgUrl}); 
    }
}